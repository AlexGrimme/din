...
names = ["Денис", "Олександр", "Станіслав", "Павло", "Євген", "Володимир", "Максим", "Олексій",
         "Анастасія", "Ірина", "Микола", "В'ячеслав", "Богдан", "Назар", "Дмитро", "Артем",
         "Геннадій", "Данило","Василь","Дарина"]
generation = 0
...
class Dino:
    ...
    def draw(self, scr, fnt=None):
        ...
        if fnt is not None:
            c_label = fnt.render(self.name.capitalize(), True, (0, 0, 0))
...
def run_game(genomes, config):
    ...
    while True:
        ...
        score_label = score_font.render("Рахунок: " + str(math.floor(score)), True, (255, 255, 255))
        score_label_rect = score_label.get_rect()
        score_label_rect.center = (width - 140, 50)
        ...
        # display game speed
        score_label = score_font.render("Швидкість: " + str(game_speed / 8) + "x", True, (255, 255, 255))
        score_label_rect = score_label.get_rect()
        score_label_rect.center = (160, 50)
        screen.blit(score_label, score_label_rect)
